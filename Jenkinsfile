                ...
                script {
                    ...
                    withCredentials([string(credentialsId: 'seeker-agent-token', variable: 'SEEKER_AGENT_TOKEN')]) {
                        if (!fileExists('seeker/seeker-agent.jar')) {
                            ...
                            // Đã xóa cờ -k ở lệnh curl dưới đây
                            sh """
            ...
            steps {
                script {
                    ...
                    sh """
                        ...
                        # --- 1. Service / Debug / Menu Endpoints (Rất nhiều method lạ) ---
                        # lessonmenu.mvc
                        ...
                        # --- 4. Other Specific Endpoints (SSRF, IDOR, XXE...) ---
                        # SSRF
                        ...
                        # Trigger error paths observed: \${server.error.path:\${error.path:/error}}
